<?php
/**
 * Chic Lite Customizer Slider Control.
 * 
 * @package Chic_Lite
*/
...
if ( ! class_exists( 'Chic_Lite_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Chic_Lite_Slider_Control extends WP_Customize_Control {

		public $type = 'chic-lite-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'chic-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'chic-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
